...
public class HomeController {
    ...
    public HomeController(UserService userService, UserSecurityService userSecurityService,
                          UserPaymentService userPaymentService, EmailService emailService,
                          BookService bookService, CartItemService cartItemService, OrderService orderService,
    ...
    public String newUserPost(
        ...
        emailService.constructAndSendEmail(appUrl, request.getLocale(),
                token, user, password);
    ...
    public String newUser(
        ...
        //make sure that current login is in session
